...
<div class="espaciadormio" style="height: 20px;"></div>
    ...
    <div class="form-row">
        ...
        <?= $campos->CampoEditable($ciudadano, 'apellido_p', 'Apellido Paterno*',2) ?>
        <?= $campos->CampoEditable($ciudadano, 'apellido_m', 'Apellido Materno*',2) ?>
        <?= $campos->CampoEditable($ciudadano, 'nombres', 'Nombres*',2) ?>
        
        <?= $campos->Fechas($ciudadano, 'fecha_nacimiento', 'Fecha Nacimiento*',2) ?>

        <?= $campos->ListaSiNo($ciudadano, 'vulnerable', 'Vulnerable',2) ?>
