<?php
    ...
    $sql_query = $con->prepare('SELECT *, ciudadanos.usuario_sistema, DATEDIFF(tareas.fecha_limite, CURDATE()) AS "dias" FROM tareas, ciudadanos WHERE tareas.id_empleado_asigna_tarea = ciudadanos.id_ciudadano AND id_empleado_asigna_tarea =? AND tareas.realizada =0');
